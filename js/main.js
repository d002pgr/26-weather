...
import { saveFavoriteCities,  saveCurrentCity, setSavedData, setSavedCurrentCity} from './storageCode.js'

constants.inputField.addEventListener('submit', getNameForRequest);
constants.cityList.addEventListener('click', getNameForRequest);
...
function getNameForRequest(event) {
    let nameForRequest;
